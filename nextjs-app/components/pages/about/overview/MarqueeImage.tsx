...
const MarqueeImage: FC = () => {
  ...
  return (
    <div className="relative bg-white py-[120px]">
      <Wave color="white" />
      <div className="container text-center">
        <h2 className="text-h2 text-blue-8">第七屆引水人們想傳達的話</h2>

        <p className="mt-7 text-subtitle-lg text-neutral-8">
          我們求新求變，不斷打磨
          <br />
          只為打造最值得投入的職涯交流旅程
          <br />
        ...
        <MarqueeContainer>
          {imageList.map((image, index) => (
            <div
              ...
              className="sm:w-[533.33px] relative mr-7 aspect-[266.66/200] w-[266.66px] overflow-hidden rounded-3 lg:w-[666.66px]"
            >
