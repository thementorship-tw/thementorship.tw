...
const Banner = () => {
  const backgroundLgProps = getImageProps({
  ...
  const backgroundMdProps = getImageProps({
  ...
  const backgroundSmProps = getImageProps({
  ...
  return (
    ...
    >
      ...
      <picture className="absolute inset-0">
        <source
          media="(min-width: 840px)"
          srcSet={backgroundLgProps.props.srcSet}
          sizes={backgroundLgProps.props.sizes}
        />
        <source
          media="(min-width: 600px)"
          srcSet={backgroundMdProps.props.srcSet}
          sizes={backgroundMdProps.props.sizes}
        />
        <img
          {...backgroundSmProps.props}
          alt={backgroundSmProps.props.alt}
          className={twMerge(
            "absolute w-full h-full object-cover -z-40",
            "object-left-bottom lg:object-[left_90%]"
          )}
        />
      </picture>
    </div>
